...
## generated by the illumina genome variant analyzer to vcf files.       ##
## Run as: perl 01_b_convert_tsv_to_vcf.pl inputfile.tsv			 ##
###########################################################################
##***************************ASSUMPTION
...
## Extract sample name for the tsv file
...
## Initiliaze variables and data structures
...
while( my $tsv_line = <TS> ){
	...
	if($tsv_line=~m/^Gene\_0.*/){
		...
		my $out_str=&writeHeadersToVCF; ## Calling subroutine
